...
/// <summary>
/// Represents a display driver for <see cref="HotmailSettings"/>.
/// </summary>
/// <remarks>
/// Initializes a new instance of <see cref="HotmailSettingsDisplayDriver"/>.
/// </remarks>
...
public class HotmailSettingsDisplayDriver(
    IDataProtectionProvider dataProtectionProvider,
    IShellHost shellHost,
    ShellSettings shellSettings,
    IHttpContextAccessor httpContextAccessor,
    IAuthorizationService authorizationService) : SectionDisplayDriver<ISite, HotmailSettings>
{
    public const string GroupId = "hotmail";

    /// <inheritdoc/>
    public override async Task<IDisplayResult> EditAsync(ISite model, HotmailSettings section, BuildEditorContext context)
    {
        ...
        {
            Initialize<HotmailSettings>("HotmailSettings_Edit", model =>
            {
        ...
        {
            shapes.Add(Dynamic("HotmailSettings_TestButton").Location("Actions").OnGroup(GroupId));
        }
    ...
    /// <inheritdoc/>
    public override async Task<IDisplayResult> UpdateAsync(ISite model, HotmailSettings section, UpdateEditorContext context)
    {
        var user = httpContextAccessor.HttpContext?.User;
